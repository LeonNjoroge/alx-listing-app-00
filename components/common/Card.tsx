...
const CardComponent = (props: PropertyProps) => {
    return (
        <div className="rounded-xl shadow-md border border-gray-200 p-4 w-full max-w-sm bg-white space-y-4">
            {/* Top image */}
            ...
            <div className="flex flex-wrap gap-2">
                {props.category.map((category, inx) => (
                    <div
                        key={inx}
            ...
            <div className="flex justify-between items-start">
                ...
                <div className="flex items-center text-xs text-yellow-500 gap-1">
                    ...
                    <span className="font-medium text-gray-700">{props.rating}</span>
                </div>
            </div>
            ...
            <div className="flex justify-between items-center">
                <div className="flex gap-3 border border-gray-300 rounded-2xl px-3 py-2">
                    ...
                    <div className="flex items-center gap-1 text-xs text-gray-600">
                        <Image src={bath} alt="Showers present" width={14} height={14} />
                        <span>{props.offers.shower}</span>
                    </div>

                    <div className="flex items-center gap-1 text-xs text-gray-600">
                        <Image src={people} alt="Number of guests" width={14} height={14} />
